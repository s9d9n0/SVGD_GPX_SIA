...
################################################## ----
##
## Connexion a la nouvelle base Centreon ----
...
folder <- paste0("C:/Users/siar_ycg8l6/ProgR/HistoCentreon_User/Fichiers_date_",format(Sys.time(),'%Y%m%d'))
...
write.csv2(Req_Glob, 
           paste0(folder,"/df_CentreonSIA_User_",str_sub(lib_date_jr,3,16),".csv"),
           row.names=FALSE)
