...
listing <- list.files(rep_sas) %>% as.data.frame() %>% 
     ...
     filter(str_detect(liste_fich,"df_delta_group") | 
            str_detect(liste_fich,"df_regroup") |
            str_detect(liste_fich,"df_delta_group_jour") | 
            str_detect(liste_fich,"df_regroup_jour") |
            str_detect(liste_fich,"resum_jour") ) 
