...
Result <- rbind(#read.csv2(paste0(repfichier,"Result_","20230121","_","11h",".csv")),
                read.csv2(paste0(repfichier,"Result_","20240501","_","00h",".csv"))) %>% 
...
Result2 <- Result %>% filter(!(service_description=="QoE-APIM-RequetesDirect-Sirene_1" &
                             ...
                             !(str_detect(service_description,"QoE-ESANE-AntGuyane")) &
                             !(str_detect(service_description,"QoE-ESANE-Reunion")) &
                                  
                             !(service_description=="QoE-RP-Questionnaire" &
                               host_name=="PDSPVSELENWD114.ad.insee.intra") & 
                             !(service_description=="QoE-RP-Omer" &
                               host_name=="PDSPVSELENWD113.ad.insee.intra") & 
                                  
                             !(service_description=="QoE-SIRENE-IHM-Habilitateur" &
                               host_name=="PDSPVSELENWD107.ad.insee.intra") &                                 
                             !(service_description=="QoE-SIRENEG-Atene" &
                               host_name=="PDSPVSELENWD105.ad.insee.intra") & 
                             !(service_description=="QoE-SIRENEG-Web_Externe" &
                               host_name=="PDSPVSELENWD107.ad.insee.intra") & 
...
Result_agreg <- rbind(#read.csv2(paste0(repfichier,"Result_agreg_","20230113","_","23h",".csv")),
                      read.csv2(paste0(repfichier,"Result_agreg_","20240501","_","00h",".csv"))) %>% 
