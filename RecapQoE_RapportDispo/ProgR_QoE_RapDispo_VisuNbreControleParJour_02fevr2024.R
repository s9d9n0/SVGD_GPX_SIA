...
repfichier <- "C:/Users/siar_ycg8l6/ProgrammesR_Gepex/Centreon_RecapQoE_RapportDispo/"
...
# le 24 janv. désactivation coleman !

Result <- rbind(#read.csv2(paste0(repfichier,"Result_","20230121","_","11h",".csv")),
                read.csv2(paste0(repfichier,"Result_","20240301","_","00h",".csv"))) %>% 
...
Result2 <- Result %>% filter(!(service_description=="QoE-APIM-Connected-BDM" &
                               host_name=="pdseleniumwst01.ad.insee.intra") &
                             !(service_description=="QoE-APIM-Connected-BDM" &
                               host_name=="pdseleniumwst05.ad.insee.intra") &
                                  
                             # !(service_description=="QoE-APIM-Connected-DL" &
                             #   host_name=="pdseleniumwst01.ad.insee.intra") &
                              
                             !(service_description=="QoE-APIM-Connected-Rmes-Meta" &
                               host_name=="pdseleniumwst04.ad.insee.intra") &
                                  
                             !(service_description=="QoE-APIM-Connected-Sirene" &
                               host_name=="pdseleniumwst01.ad.insee.intra") &   
                             !(service_description=="QoE-APIM-Connected-Sirene" &
                               host_name=="pdseleniumwst03.ad.insee.intra") & 
                               
                             !(service_description=="QoE-APIM-RequetesDirect-Sirene_1" &
                               host_name=="PDSPVSELENWD103.ad.insee.intra") &
                                  
                             !(service_description=="QoE-COLTRANE-Compte" &
                               host_name=="pdseleniumwst04.ad.insee.intra") &

                             !(service_description=="QoE-COLTRANE-Enquete" &
                               host_name=="pdseleniumwst04.ad.insee.intra") &
                                  
                             !(service_description=="QoE-COLTRANE-Enquete2" &
                               host_name=="pdseleniumwst05.ad.insee.intra") &
                             ...
                             # !(service_description=="QoE-LEI-France" &
                             #   host_name=="pdseleniumwst01.ad.insee.intra") &

                             !(service_description=="QoE-OWA-Mail_Interne" &
                               host_name=="PDSPVSELENWD101.ad.insee.intra") &
                             !(service_description=="QoE-OWA-Mail_Pro" &
                               host_name=="PDSPVSELENWD102.ad.insee.intra") &
                                  
                             !(service_description=="QoE-SIRENE-Diffcom" &
                               host_name=="pdseleniumwst02.ad.insee.intra") &

                             !(service_description=="QoE-SIRENE-WebCFE" &
                               host_name=="pdseleniumwst03.ad.insee.intra") &
                             
                             !(service_description=="QoE-SYRACUSE" &
                                    host_name=="pdseleniumwst02.ad.insee.intra") &
                             
                             # !(service_description=="QoETEST-OCAPI-Series" &
                             #        host_name=="PDSPVSELENWD115.ad.insee.intra")
...
Result_agreg <- rbind(#read.csv2(paste0(repfichier,"Result_agreg_","20230113","_","23h",".csv")),
                      read.csv2(paste0(repfichier,"Result_agreg_","20240301","_","00h",".csv"))) %>% 
...
Result_agreg2 <- Result_agreg %>%
                           filter(!(service_description=="QoE-APIM-Connected-BDM" &
                                         host_name=="pdseleniumwst01.ad.insee.intra") &
                                  !(service_description=="QoE-APIM-Connected-BDM" &
                                         host_name=="pdseleniumwst05.ad.insee.intra") &
