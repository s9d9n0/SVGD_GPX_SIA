...
Result <- rbind(#read.csv2(paste0(repfichier,"Result_","20230121","_","11h",".csv")),
                read.csv2(paste0(repfichier,"Result_","20240712","_","00h",".csv"))) %>% 
...
Result2 <- Result %>% filter(!(service_description=="QoE-APIM-RequetesDirect-Sirene_1" &
                             ...
                             !(service_description=="QoE-SIRENEG-Atis_Consultation" &
                               host_name=="PDSPVSELENWD112.ad.insee.intra") &
                             !(service_description=="QoE-SIRENEG-Rgs" &
                               host_name=="PDSPVSELENWD106.ad.insee.intra") &
                             !(service_description=="QoE-SIRENEG-Tdb" &
                               host_name=="PDSPVSELENWD104.ad.insee.intra") &
                                  
                             !(service_description=="QoE-WS-Atis_BRPP" &
                               host_name=="PDSPVSELENWD102.ad.insee.intra") &
                             !(service_description=="QoE-WS-Atis_Sicore" &
                               host_name=="PDSPVSELENWD103.ad.insee.intra") &
...
Result_agreg <- rbind(#read.csv2(paste0(repfichier,"Result_agreg_","20230113","_","23h",".csv")),
                      read.csv2(paste0(repfichier,"Result_agreg_","20240712","_","00h",".csv"))) %>% 
